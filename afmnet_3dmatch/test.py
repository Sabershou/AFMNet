...
import numpy as np
import os
from others.engine import SingleTester
from others.utils.torch import release_cuda
from others.utils.common import ensure_dir, get_log_string
...
class Tester(SingleTester):
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        np.savez_compressed(
            ...
            ref_node_corr_knn_indices=release_cuda(output_dict['ref_node_corr_knn_indices']),
            src_node_corr_knn_indices=release_cuda(output_dict['src_node_corr_knn_indices']),
