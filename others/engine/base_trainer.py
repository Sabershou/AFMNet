...
from others.utils.timer import Timer
from others.utils.torch import all_reduce_tensors, release_cuda, initialize
...
def inject_default_parser(parser=None):
    ...
    parser.add_argument('--resume', default=None, action='store_true', help='resume training')
